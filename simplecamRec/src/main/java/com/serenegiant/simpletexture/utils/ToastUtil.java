 ...
 * @author Darcy
 * @project CyhApp
 * @package com.darcy.menudemo.ToastUtil
 * @time 2018-8-3 16:27
 */
public class ToastUtil {
    ...
    public static void customToast(Context context, String msg, int imageResId) {
        ...
        TextView tvMsg = (TextView) vContent.findViewById(R.id.tv_message);
        tvMsg.setText(msg);
        if (IMAGE_RESID_NONE != imageResId) {
            ImageView ivIcon = (ImageView) vContent.findViewById(R.id.iv_icon);

...
////////////////////////////  CYS zxcz  ///////////////////////////
#define UVC_SONIX_SN986_USR_XU_CTRL_UID         0x04
...
/* device management sub-command ID */
#define XU_USR_DEV_SUB_GETTIME			0x00	/**< Get device system date. */
#define XU_USR_DEV_SUB_SYNCTIME			0x01	/**< Synchronize device system date. */
#define XU_USR_DEV_SUB_GETBATTERY		0x02	/**< Get device battery status. */
#define XU_USR_DEV_SUB_GETDEVPARAM		0x03	/**< Get device parameters. */
#define XU_USR_DEV_SUB_GETDEVVERSION	0x04	/**< Get device version. */
#define XU_USR_DEV_SUB_SETPWRFREQ		0x05	/**< Set device power frequency. */
#define XU_USR_DEV_SUB_SETGSENSORPARAM	0x06	/**< Set G-Sensor parameters. */
#define XU_USR_DEV_SUB_GETGSENSORINFO	0x07	/**< Get G-Sensor informations. */
#define XU_USR_DEV_SUB_NVRAMRESETDEF	0x08	/**< Reset NVRAM settings to default value. */
#define XU_USR_DEV_SUB_REBOOT			0x09	/**< Device reboot. */

/* video management sub-command ID */
#define XU_USR_VID_SUB_GETVIDPARAM		0x00	/**< Get video parameters. */
#define XU_USR_VID_SUB_SETVIDPARAM		0x01	/**< Set video parameters. */
#define XU_USR_VID_SUB_SETWDR			0x02	/**< Set WDR function. */
#define XU_USR_VID_SUB_SETMIRROR		0x03	/**< Set video mirror function. */
#define XU_USR_VID_SUB_SETFLIP			0x04	/**< Set video flip function. */

/* record management sub-command ID */
#define XU_USR_REC_SUB_TAKEPIC			0x00
#define XU_USR_REC_SUB_GETRECSTA		0x01
#define XU_USR_REC_SUB_SETRECSTA		0x02
#define XU_USR_REC_SUB_SETRECPARAM		0x03
#define XU_USR_REC_SUB_SETRECAUDSTA		0x04
#define XU_USR_REC_SUB_SETRECLEN		0x05
#define XU_USR_REC_SUB_SETPRTLEN		0x06
#define XU_USR_REC_SUB_SETLRECSTA		0x07
#define XU_USR_REC_SUB_GETRECCAP		0x08

/* sd-card management sub-command ID */
#define XU_USR_SD_SUB_GETSPACE			0x00
#define XU_USR_SD_SUB_SETFORMAT			0x01

/* control selector control and mapping length */
#define LENGTH_OF_SONIX_XU_USR_CTR		(XU_USR_CS_COUNT - 1)
#define LENGTH_OF_SONIX_XU_USR_MAP		(XU_USR_CS_COUNT - 1)

/* control selector length */
#define XU_USR_CS_LEN				0x40

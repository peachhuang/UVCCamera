...
public class UVCCamera {
	...
	private static final String TAG = "zxcam";//UVCCamera.class.getSimpleName();
...
//			System.loadLibrary("ffmpegjni");
			System.loadLibrary("zxuv");
			System.loadLibrary("zxcam");
			isLoaded = true;
		}
	}
...
//================================================================================
	public synchronized void updateCameraParams() {
		//Log.e(TAG, "  updateCameraParams; " + (mNativePtr != 0));
    	if (mNativePtr != 0) {
